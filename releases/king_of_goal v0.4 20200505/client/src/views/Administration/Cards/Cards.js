...
*==============================================================================
* Description: Render the view of the cards control
*==============================================================================
* Constant: Cards
*==============================================================================
*/
...
const Cards = props => {
  ...
  /*========== USE EFFECT ===================================================*/
    ...
    */
    ...
    /*
    *--------------------------------------------------------------------------
    * Description: Set form fields states when active card state changes
    *--------------------------------------------------------------------------
    * Parameters: activeCardState
    *--------------------------------------------------------------------------
    * Created on: 21/04/2020 by Acua
    *--------------------------------------------------------------------------
    */
  ...
  /*========== FUNCTIONS ====================================================*/
    ...
    */
    ...
    /*
    *--------------------------------------------------------------------------
    * Name: onSubmitInsertCardFormHandler
    *--------------------------------------------------------------------------
    ...
    */
    ...
    /*
    *--------------------------------------------------------------------------
    * Name: onSubmitUpdateCardFormHandler
    *--------------------------------------------------------------------------
