...
const Card = props => {
  ...
  const {classes, click, sizeType, size, extraClasses, type, textColor, player, rating, position, country, team, name, pace, shooting, passing, dribbling, defending, physicality} = props;
