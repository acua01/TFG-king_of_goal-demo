...
*=============================================================================
* Title: Packs.js
* Created on: 06/05/2020  by Acua
* Copyright: Acua. All Rights Reserved.
*==============================================================================
* Description: Render the view of the packs control
*==============================================================================
* Constant: Packs
*==============================================================================
*/
...
const Packs = props => {
  ...
  /*========== USE EFFECT ===================================================*/
    ...
    */
    /*
    *--------------------------------------------------------------------------
    * Description: Load packs when packs state change
    *--------------------------------------------------------------------------
    * Parameters: None
    *--------------------------------------------------------------------------
    * Created on: 06/05/2020 by Acua
    ...
    */
    ...
    /*
    *--------------------------------------------------------------------------
    * Description: Set form fields states when active pack state changes
    *--------------------------------------------------------------------------
    * Parameters: activePackState
    *--------------------------------------------------------------------------
    * Created on: 06/05/2020 by Acua
    *--------------------------------------------------------------------------
    */
  ...
  /*========== FUNCTIONS ====================================================*/
    ...
    */
    ...
    /*
    *--------------------------------------------------------------------------
    * Name: onSubmitInsertPackFormHandler
    *--------------------------------------------------------------------------
    ...
    */
    ...
    /*
    *--------------------------------------------------------------------------
    * Name: onSubmitUpdatePackFormHandler
    *--------------------------------------------------------------------------
        ...
        <div className={classes.packsFormView}>
          ...
          <form onSubmit={(event) => {activePackState ? onSubmitUpdatePackFormHandler(event) : onSubmitInsertPackFormHandler(event)}}>
            ...
            <div className={classes.field}>
              ...
              <input type="number" id="number_players" placeholder="Nº jugadores" value={numberPlayersState} onChange={(event) => setNumberPlayersState(event.target.value)}/>
            </div>
            <div className={classes.field}>
              <label for="price"><Icon name='money' className={classes.icon} size="large"/></label>
              <input type="number" id="price" placeholder="Precio" value={priceState} onChange={(event) => setPriceState(event.target.value)}/>
            </div>
