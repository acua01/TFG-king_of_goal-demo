...
export const useActionsServerRequests = (state, dispatch) => {
  ...
  const sendRequestToInsertSquad = async(data) => {
    try{
      dispatch({
        type: types.GENERAL_TYPE,
        section: 'loader',
      ...
      const response = await axios.post('/create_squad', data);
  ...
  const sendRequestToDeleteSquad = async(data) => {
    try{
      dispatch({
        type: types.GENERAL_TYPE,
        section: 'loader',
      ...
      const response = await axios.post('/delete_squad', data);
  ...
  const sendRequestToUpdateSquad = async(data) => {
    try{
      dispatch({
        type: types.GENERAL_TYPE,
        section: 'loader',
      ...
      const response = await axios.post('/update_squad', data);
  ...
  const askForAllSquadCards = async(data) => {
    try{
      dispatch({
        type: types.GENERAL_TYPE,
        section: 'loader',
      ...
      const response = await axios.post('/squad_cards', data);
  ...
  const sendRequestToUpdateSquadCard = async(data) => {
    try{
      dispatch({
        type: types.GENERAL_TYPE,
        section: 'loader',
      ...
      const response = await axios.post('/update_squad_card', data);
  ...
  return {
    ...
    sendRequestToInsertSquad,
    sendRequestToDeleteSquad,
    sendRequestToUpdateSquad,
    askForAllSquadCards,
    sendRequestToUpdateSquadCard
