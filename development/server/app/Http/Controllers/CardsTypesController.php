...
class CardsTypesController extends Controller{
  ...
  public function insert(Request $request){
    ...
    try{
      ...
      DB::statement("INSERT INTO cards_types VALUES(NULL, :name, :image, :image_mini, :rare)", [
        'name'=>$name,
        'image'=>$urlImage,
  ...
  public function update(Request $request){
    ...
    try{
      ...
      DB::statement("UPDATE cards_types SET name=:name, image=:image, image_mini=:image_mini, rare=:rare WHERE id=:id", [
        'name'=>$name,
        'image'=>$urlImage,
        'image_mini'=>$urlImageMini,
        'rare'=>$rare,
