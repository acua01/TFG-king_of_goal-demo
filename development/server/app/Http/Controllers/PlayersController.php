...
class PlayersController extends Controller{
  ...
  public function update(Request $request){
    $messages = [
      ...
      //'image.required'=>'Introduce la imagen.',
      //'image.string'=>'La imagen debe ser una cadena.',
      //'image.max'=>'La imagen debe tener un máximo de 500 caracteres.',
      //'image.regex'=>'La imagen debe tener caracteres alfanuméricos.',
    ...
    $this->validate($request, [
      ...
      //'image'=>'required|string|max:500|regex:/^[a-zA-Z0-9\ ]+$/i',
      'height'=>'required|numeric|max:3',
    ], $messages);
    ...
    try{
      DB::statement("UPDATE players SET name=:name, full_name=:full_name, height=:height WHERE id=:id", [
        'name'=>$name,
        'full_name'=>$full_name,
        //'image'=>$image,
        'height'=>$height,
